...
const form = useForm({
    ...
    specs: props.product.specs || {} as Record<string, string>,
    ...
    <AdminLayout>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
                <div>
                    <h1 class="text-2xl sm:text-3xl font-bold text-black">Edit Product</h1>
                ...
                <div class="bg-white rounded-lg border border-gray-200 p-6 space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-sm text-gray-500">
                                    Use the stock update feature in the product list for inventory tracking.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <!-- Image Upload -->
                            <div>
                                <label class="block text-sm font-medium text-black mb-2">Upload New Image</label>
                                <input
                                    type="file"
